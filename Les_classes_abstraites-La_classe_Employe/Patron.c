...
static void Patron_Init(Patron*);

static char* toString( Employe *This);

/******************************************************************************/
Patron* New_Patron(char *matricule,char *nom,char *prenom,date dateNaissance)
{
    Patron *This = malloc(sizeof(Patron));
    if(!This) return NULL;
    Patron_Init(This);
...
/******************************************************************************/
static void Patron_Init(Patron *This)
{
